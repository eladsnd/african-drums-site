...
export function WhatsAppButton({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-3 rounded-full bg-[#25D366] px-8 py-4 text-base font-bold text-white shadow-lg shadow-green-600/25 transition hover:scale-[1.02] hover:bg-[#20bd5a] ${className}`}
    >
